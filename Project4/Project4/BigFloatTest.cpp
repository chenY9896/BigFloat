...
TEST(testBigFloatCreate, normalTest)
{
	...
	ASSERT_TRUE(BigFloat("-01234567890.123456789000").toString() == "-1234567890.123456789");
}
...
TEST(testBigFloatCompare, normalTest)
{
	...
	ASSERT_TRUE(BigFloat("123456789123456789.123456789") > BigFloat("000123456789123456789.1234567800000"));
...
TEST(testLargeIntMul, normalTest1)
{
	...
	ASSERT_TRUE(BigFloat("1234567") * BigFloat("7654321") == BigFloat("9449772114007"));
	ASSERT_TRUE(BigFloat("898.4143988") * BigFloat("0.00877838371") == BigFloat("7.886626323255363548"));
...
TEST(testBigFloatDiv, normalTest)
{
		...
		ASSERT_TRUE(BigFloat("-0.00005") / BigFloat("0.4") == BigFloat("-0.000125"));
		...
		ASSERT_TRUE(BigFloat("123412341234123412341234123412341289430984095.8328452930854923984721374109578034") / BigFloat("120934789347523984502394852389459832.348983043051234") == BigFloat("1020486676.331653552980955068698992382482089343"));
